...
export class SEOHooks {
  ...
  generateResearchArticleSchema(publication: any): ArticleSchema {
    return {
      ...
      url: `${import.meta.env.SITE || 'https://rrocap.github.io'}${import.meta.env.BASE_URL}en/research/${publication.slug}`,
      image: publication.image || `${import.meta.env.SITE || 'https://rrocap.github.io'}${import.meta.env.BASE_URL}research-default.jpg`,
