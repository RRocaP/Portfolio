...
export const projects: Project[] = [
  {
    ...
    image: '/Portfolio/hero/protein-structure.jpg',
    technologies: ['Protein Engineering', 'E. coli Expression', 'Biophysical Analysis', 'Structural Biology'],
    category: 'research',
    year: 2024,
    status: 'published',
    links: {
      paper: '/Portfolio/en/research/functional-inclusion-bodies',
  ...
  },
  {
    ...
    image: '/Portfolio/hero/liver-perfusion.jpg',
    technologies: ['AAV Vectors', 'Organ Perfusion', 'Gene Therapy', 'Molecular Imaging'],
    category: 'research',
    year: 2023,
    status: 'published',
    links: {
      paper: '/Portfolio/en/research/harnessing-whole-human-liver-ex-situ-normothermic-perfusion-for-preclinical-aav-vector-evaluation',
  ...
  },
  {
    ...
    image: '/Portfolio/hero/car-t-cells.jpg',
    technologies: ['Directed Evolution', 'CAR-T Cells', 'Capsid Engineering', 'Immunotherapy'],
    category: 'research',
    year: 2023,
    status: 'published',
    links: {
      paper: '/Portfolio/en/research/tailoring-capsid-directed-evolution-technology-for-improved-aav-mediated-car-t-generation',
  ...
  },
  {
    ...
    image: '/Portfolio/hero/timeline-viz.jpg',
  ...
  },
  {
    ...
    image: '/Portfolio/hero/protein-viz.jpg',
    ...
    links: {
      ...
      demo: '/Portfolio/en/#protein-showcase'
    },
    metrics: {
      stars: 32
    },
  ...
  },
  {
    ...
    image: '/Portfolio/hero/ai-system.jpg',
