...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "description": description }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Navigation", $$Navigation, { "lang": lang })} ${maybeRenderHead()}<main class="min-h-screen"> ${renderSlot($$result2, $$slots["default"])} </main> ${renderComponent($$result2, "Footer", $$Footer, {})} ` })}`;
}, "/Users/ramon/Portfolio/src/layouts/BaseLayout.astro", void 0);
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="home" class="relative min-h-screen flex items-center justify-center overflow-hidden"> <!-- Background gradient with noise texture --> <div class="absolute inset-0 bg-gradient-hero opacity-90"></div> <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width=" 100" height="100" xmlns="http://www.w3.org/2000/svg" %3E%3Cfilter id="noise" %3E%3CfeTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" %3E%3C filter%3E%3Crect width="100" height="100" filter="url(%23noise)" opacity="0.05" %3E%3C svg%3E')] opacity-20"></div> <!-- Content --> <div class="container-custom relative z-10"> <div class="max-w-4xl mx-auto text-center"> <h1 class="text-hero font-display font-black mb-6 animate-fade-in-up"> ${title} </h1> <div class="w-24 h-1 bg-gradient-to-r from-accent-yellow to-accent-red mx-auto mb-8 animate-fade-in-up animate-delay-1"></div> <p class="text-2xl md:text-3xl text-text-secondary mb-4 animate-fade-in-up animate-delay-2"> ${subtitle} </p> <p class="text-lg md:text-xl text-text-muted mb-10 animate-fade-in-up animate-delay-3"> ${tagline} </p> <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up animate-delay-3"> <a href="#research" class="btn btn-primary">
Explore Research
...
const $$Research = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="research" class="section-padding bg-surface-elevated"> <div class="container-custom"> <h2 class="text-section font-display font-black text-center mb-4">Research Focus</h2> <div class="w-24 h-1 bg-gradient-to-r from-accent-yellow to-accent-red mx-auto mb-16"></div> <div class="grid grid-auto-fit gap-8"> ${researchAreas.map((area, index) => renderTemplate`<article class="card group hover:translate-y-[-4px] transition-all duration-300"> <div class="text-5xl mb-6 group-hover:scale-110 transition-transform duration-300">${area.icon}</div> <h3 class="text-subsection font-display font-bold mb-4 gradient-text">${area.title}</h3> <p class="text-text-secondary mb-6 leading-relaxed">${area.description}</p> <ul class="space-y-2"> ${area.highlights.map((highlight) => renderTemplate`<li class="flex items-center text-sm text-text-muted"> <span class="w-1 h-1 bg-accent-red rounded-full mr-3"></span> ${highlight} </li>`)} </ul> </article>`)} </div> </div> </section>`;
...
const $$Timeline = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="about" class="section-padding"> <div class="container-custom"> <h2 class="text-section font-display font-black text-center mb-4">My Journey</h2> <div class="w-24 h-1 bg-gradient-to-r from-accent-yellow to-accent-red mx-auto mb-16"></div> <div class="relative"> <!-- Timeline line --> <div class="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-gradient-to-b from-accent-yellow to-accent-red opacity-30"></div> <!-- Timeline events --> <div class="space-y-12"> ${timelineEvents.map((event, index) => renderTemplate`<div${addAttribute(`relative flex items-center ${index % 2 === 0 ? "justify-start" : "justify-end"}`, "class")}> <div${addAttribute(`w-5/12 ${index % 2 === 0 ? "text-right pr-8" : "text-left pl-8"}`, "class")}> <div class="inline-block"> <span class="text-accent-yellow font-mono text-sm">${event.year}</span> <h3 class="text-xl font-bold mt-1">${event.title}</h3> <p class="text-accent-red font-medium">${event.institution}</p> <p class="text-text-secondary text-sm mt-2">${event.description}</p> </div> </div> <!-- Center dot --> <div class="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-accent-red rounded-full border-4 border-primary-black"></div> </div>`)} </div> </div> </div> </section>`;
...
export { $$BaseLayout as $, $$Hero as a, $$Timeline as b, $$Research as c, $$Publications as d, $$Contact as e };
